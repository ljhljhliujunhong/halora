...
contextBridge.exposeInMainWorld("workshop", {
  ...
  turnChanges: (value) => ipcRenderer.invoke('turn-changes', value),
  turnChangeDiff: (value) => ipcRenderer.invoke('turn-change-diff', value),
  undoTurnChanges: (value) => ipcRenderer.invoke('undo-turn-changes', value),
